...
async function main() {
    /*Deploy Contract in ethers.js in an abstraction used to deploy new 
    smart contracts.
    so random winnergame here is a factory for instances of our RandomWinnerGame contract
    */
